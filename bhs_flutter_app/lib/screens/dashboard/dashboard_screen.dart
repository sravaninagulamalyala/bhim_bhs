...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cards = <_DashCard>[
      ...
      if (Roles.isSecretary(role) || Roles.isSuperAdmin(role)) _DashCard('Attendance', Icons.fact_check, const MarkAttendanceScreen()),
      if (!Roles.isSecretary(role) && !Roles.isSuperAdmin(role)) _DashCard('Attendance View', Icons.visibility, const ViewAttendanceScreen()),
      if (Roles.isTreasurer(role) || Roles.isSuperAdmin(role)) _DashCard('Transactions', Icons.payments, const TransactionEntryScreen()),
      if (!Roles.isTreasurer(role) && !Roles.isSuperAdmin(role)) _DashCard('Transactions View', Icons.receipt_long, const TransactionViewScreen()),
